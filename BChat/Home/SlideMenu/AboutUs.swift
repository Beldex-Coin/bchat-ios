...
class AboutUs: BaseVC {
    ...
    private lazy var aboutDetailsTextView: UITextView = {
        ...
        result.scrollIndicatorInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: -5)
        return result
    }()
    ...
    override func viewDidLoad() {
        ...
        backgroundView.addSubview(aboutDetailsTextView)
        NSLayoutConstraint.activate([
            backgroundView.topAnchor.constraint(equalTo: view.topAnchor, constant: 0),
            backgroundView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 0),
            backgroundView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -0),
            backgroundView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -0),
            aboutDetailsTextView.topAnchor.constraint(equalTo: backgroundView.topAnchor, constant: 20),
            aboutDetailsTextView.leadingAnchor.constraint(equalTo: backgroundView.leadingAnchor, constant: 20),
            aboutDetailsTextView.bottomAnchor.constraint(equalTo: backgroundView.bottomAnchor, constant: -10),
            aboutDetailsTextView.trailingAnchor.constraint(equalTo: backgroundView.trailingAnchor, constant: -20),
        ])
    }
}
