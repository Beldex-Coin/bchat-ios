...
class ChangeLogVC: BaseVC, UITableViewDelegate, UITableViewDataSource,ExpandableHeaderViewDelegate {
    ...
    var sections = [
        Section(genre: "1.0.0",
                movies: ["- Initial release",
                         "- Added changelog"],
                expandable: false),
        Section(genre: "1.1.0",
                movies: ["- Message request implementation",
                         "- Link Preview will be turn on by default",
                         "- Add the images for SwipeActionsConfiguration"],
                expandable: false),
        Section(genre: "1.2.0",
                movies: ["- Call Feature Added",
                         "- Blocked Contact list added",
                         "- Minor Bug Fixes"],
                expandable: false),
        Section(genre: "1.2.1",
                ...
                expandable: false),
        Section(genre: "1.3.0",
                movies: ["- Wallet Integration Beta release",
