...
class LandingNewVC: BaseVC {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            createButton.topAnchor.constraint(equalTo: explanationLabel.bottomAnchor, constant: 160),
            ...
            restoreButton.topAnchor.constraint(equalTo: createButton.bottomAnchor, constant: 14),
            ...
            isTermsAndConditionsButton.topAnchor.constraint(equalTo: restoreButton.bottomAnchor, constant: 30),
            ...
            isBottomImge.topAnchor.constraint(equalTo: isCheckedOrNotButton.bottomAnchor, constant: 0),
