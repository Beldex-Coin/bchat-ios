...
class ChangeLogTableCell: UITableViewCell {
    ...
    lazy var arrowImage: UIImageView = {
        ...
        imageView.image = UIImage(named: "ic_down_buttonarrow_New", in: Bundle.main, compatibleWith: nil)?.withRenderingMode(.alwaysOriginal)
        return imageView
    }()
...
class ChangeLogTableCell2: UITableViewCell {
    ...
    lazy var expandArrowImage: UIImageView = {
        ...
        imageView.contentMode = .scaleAspectFit
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.image = UIImage(named: "ic_dropdown_arrowNew", in: Bundle.main, compatibleWith: nil)?.withRenderingMode(.alwaysOriginal)
        return imageView
    }()
    lazy var circularView: UIImageView = {
        let imageView = UIImageView()
