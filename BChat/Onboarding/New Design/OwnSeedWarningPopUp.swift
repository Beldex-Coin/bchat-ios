...
class OwnSeedWarningPopUp: BaseVC {
    ...
    private lazy var iconView: UIImageView = {
        ...
        result.image = UIImage(named: "ic_warningSeed")
    ...
    private lazy var discriptionLabel: UILabel = {
        ...
        result.translatesAutoresizingMaskIntoConstraints = false
        result.text = "This is your recovery phrase. If you send it to someone they will have full access to your account."
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            iconView.topAnchor.constraint(equalTo: backGroundView.topAnchor, constant: 27),
            ...
            discriptionLabel.leadingAnchor.constraint(equalTo: backGroundView.leadingAnchor, constant: 16),
            discriptionLabel.trailingAnchor.constraint(equalTo: backGroundView.trailingAnchor, constant: -16),
            discriptionLabel.bottomAnchor.constraint(equalTo: sendButton.topAnchor, constant: -22),
            
            buttonStackView.topAnchor.constraint(equalTo: discriptionLabel.bottomAnchor, constant: 22),
