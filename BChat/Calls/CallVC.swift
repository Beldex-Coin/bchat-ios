...
//    enum call.floatingViewVideoSource {
//        case local
//        case remote
//    }
...
//    }()
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let remoteVideoView: RemoteVideoView = self.call.floatingViewVideoSource == .remote ? self.floatingRemoteVideoView : self.fullScreenRemoteVideoView
    ...
    func setUpViewHierarchy() {
        ...
        profilePictureContainer.pin(.top, to: .bottom, of: titleLabel)
    ...
    @objc private func updateDuration() {
        ...
        titleLabel.text = call.isVideoEnabled ? "Video Call" : "Voice Call"
    }
...
//        presentingViewController?.dismiss(animated: true, completion: nil)
    ...
    func cameraDidConfirmTurningOn() {
        ...
        let localVideoView: LocalVideoView = self.call.floatingViewVideoSource == .local ? self.floatingLocalVideoView : self.fullScreenLocalVideoView
    ...
    @objc private func switchVideo() {
        if self.call.floatingViewVideoSource == .remote {
            ...
            self.call.floatingViewVideoSource = .local
            ...
            self.call.floatingViewVideoSource = .remote
